                ...
                <div className={`s-Grid-col ms-sm9 ms-xl9 ${classNames.pivot}`}>
                    <Card styles={styles.cardStyles}>
                        <Card.Section>
                                ...
                                <ChoiceGroup defaultSelectedKey="Pvt"
                                    options={options_use}
                                ...
                                {  
                                    ...
                                    <>
                                        <TextField label="Indicate the purpose for which the aerodrome
                                        will be used e.g. joy rides, air displays, miscellaneous instructional 
                                        flying, private flying etc." placeholder="Please enter text here"
                                        multiline rows={3} /> 
                                        <ChoiceGroup 
                                ...
                                <TextField label="Please provide details of proposed CNS-ATM facilities" 
                                        placeholder="Please enter text here"
                                        multiline rows={3}/>
                                <TextField label="Please provide details of proposed MET facilities" 
                                        placeholder="Please enter text here"
                                        multiline rows={3}/>
                                <TextField label="Please give details of other proposed aviation activities
                                        (for example gliding, parachuting, micro lights)." 
                                        placeholder="Please enter text here"
                                        multiline rows={3}/>
                                <TextField label="Mention the type of the largest / heaviest aircraft 
                                for which the aerodrome is designed"
                                        placeholder="Please enter text here"/>
                                <TextField label="Mention the maximum total weight of the largest / heaviest aircraft 
                                for which the aerodrome is designed"
                                        placeholder="Please enter text here"/>
                                <TextField label="Mention thr overall length of the largest / heaviest aircraft 
                                for which the aerodrome is designed"
                                        placeholder="Please enter text here"/>
                                <TextField label="Mention the maximum fuselage width of the largest / heaviest aircraft 
                                for which the aerodrome is designed"
                                        placeholder="Please enter text here"/>
